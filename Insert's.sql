...
('2026-01-05 08:30:00', 'Dolor de cabeza y mareos.', 'Hipertensión Arterial', 1, 10015, 10000),
('2026-01-06 09:00:00', 'Tos persistente y fiebre.', 'Gripe Estacional', 1, 10015, 10001),
('2026-01-08 10:30:00', 'Dolor abdominal y acidez.', 'Gastritis', 1, 10025, 10002),
('2026-01-10 11:00:00', 'Sed excesiva y cansancio.', 'Diabetes Mellitus Tipo 2', 1, 10023, 10003),
('2026-01-12 08:15:00', 'Dificultad para respirar.', 'Asma Bronquial', 1, 10024, 10004),
('2026-01-15 09:45:00', 'Dolor articular en rodillas.', 'Artritis', 1, 10022, 10005),
('2026-01-17 13:00:00', 'Cefalea intensa y fotofobia.', 'Migraña', 1, 10019, 10006),
('2026-01-20 14:30:00', 'Irritación y picazón en piel.', 'Dermatitis', 1, 10018, 10007),
('2026-01-22 08:30:00', 'Opresión torácica y fatiga.', 'Insuficiencia Cardíaca', 1, 10016, 10008),
('2026-01-25 10:00:00', 'Dolor facial y secreción.', 'Sinusitis', 1, 10024, 10009),
('2026-02-01 09:15:00', 'Aumento de peso y piel seca.', 'Hipotiroidismo', 1, 10023, 10010),
('2026-02-03 11:30:00', 'Dolor lumbar mecánico.', 'Osteoporosis', 1, 10022, 10011),
('2026-02-05 15:00:00', 'Ardor al orinar.', 'Infección Urinaria', 1, 10026, 10012),
('2026-02-07 09:30:00', 'Enrojecimiento ocular.', 'Conjuntivitis', 1, 10021, 10013),
('2026-02-10 10:45:00', 'Episodio convulsivo.', 'Epilepsia', 1, 10019, 10014);
...
(30000, 101, '2026-01-05 09:00:00', '2026-01-06 14:00:00', 'Completado', 'Colesterol total: 240 mg/dL.'),
(30001, 100, '2026-01-06 09:30:00', '2026-01-07 11:00:00', 'Completado', 'Leucocitosis leve.'),
(30003, 102, '2026-01-10 11:30:00', '2026-01-11 10:00:00', 'Completado', 'Glucosa basal: 165 mg/dL.'),
(30008, 103, '2026-01-22 09:00:00', '2026-01-23 15:00:00', 'Completado', 'Creatinina normal.'),
(30010, 105, '2026-02-01 10:00:00', '2026-02-03 12:00:00', 'Completado', 'TSH elevada.'),
(30012, 104, '2026-02-05 15:30:00', '2026-02-06 09:00:00', 'Completado', 'Bacteriuria presente.');

insert into cita (codigo_medico, codigo_cliente, fechacita, estado, motivo) values
(10015, 10000, '2026-01-05 08:00:00', 'Atendida', 'Control de presión arterial'),
(10015, 10001, '2026-01-06 09:00:00', 'Atendida', 'Evaluación de síntomas gripales'),
(10016, 10002, '2026-01-08 10:00:00', 'Atendida', 'Evaluación cardiológica inicial'),
(10017, 10003, '2026-01-10 11:00:00', 'Atendida', 'Control metabólico y glucosa'),
(10018, 10004, '2026-01-12 08:30:00', 'Atendida', 'Evaluación dermatológica'),
(10019, 10005, '2026-01-15 09:30:00', 'Atendida', 'Control por dolores articulares'),
(10020, 10006, '2026-01-17 10:30:00', 'Atendida', 'Consulta por migraña crónica'),
(10021, 10007, '2026-01-20 11:30:00', 'Atendida', 'Revisión por dermatitis alérgica'),
(10022, 10008, '2026-01-22 08:00:00', 'Atendida', 'Evaluación de dolor torácico'),
(10023, 10009, '2026-01-25 09:00:00', 'Atendida', 'Control por sinusitis aguda'),
(10024, 10010, '2026-02-01 10:00:00', 'Atendida', 'Seguimiento por hipotiroidismo'),
(10025, 10011, '2026-02-03 11:00:00', 'Atendida', 'Evaluación por dolor lumbar'),
(10026, 10012, '2026-02-05 08:30:00', 'Atendida', 'Consulta por síntomas urinarios'),
(10027, 10013, '2026-02-07 09:30:00', 'Atendida', 'Revisión oftalmológica y conjuntivitis'),
(10028, 10014, '2026-02-10 10:30:00', 'Atendida', 'Control neurológico por convulsiones'),
(10015, 10000, '2026-02-15 08:00:00', 'Atendida', 'Seguimiento de cefalea frecuente'),
(10016, 10003, '2026-02-18 09:00:00', 'Pendiente', 'Control de niveles de glucosa'),
(10018, 10005, '2026-02-20 10:00:00', 'Pendiente', 'Monitoreo de presión arterial'),
(10019, 10007, '2026-02-22 11:00:00', 'Cancelada', 'Control digestivo por gastritis'),
(10022, 10008, '2026-02-25 08:00:00', 'Pendiente', 'Revisión por cuadro respiratorio'),
(10023, 10009, '2026-03-01 09:00:00', 'Atendida', 'Control médico general'),
(10024, 10010, '2026-03-03 10:00:00', 'Pendiente', 'Seguimiento dermatológico'),
(10025, 10011, '2026-03-05 11:00:00', 'Atendida', 'Control cardiológico preventivo'),
(10026, 10012, '2026-03-08 08:30:00', 'Pendiente', 'Evaluación neurológica general'),
(10015, 10013, '2026-04-01 09:30:00', 'Pendiente', 'Cita de control trimestral'),
(10016, 10014, '2026-04-02 10:30:00', 'Pendiente', 'Seguimiento de rutina general'),
(10018, 10001, '2026-04-03 11:30:00', 'Pendiente', 'Evaluación médica programada'),
(10019, 10002, '2026-04-05 08:00:00', 'Pendiente', 'Control de especialidad'),
(10020, 10004, '2026-04-06 09:00:00', 'Pendiente', 'Revisión periódica de salud'),
(10021, 10006, '2026-04-08 10:00:00', 'Pendiente', 'Cita subsecuente de control');
