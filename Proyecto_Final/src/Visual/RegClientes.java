...
public class RegClientes extends JDialog {
    ...
    private void registrarCliente() {
        ...
        if (txtCedula.getText().isEmpty() || txtNombre.getText().isEmpty() || 
            txtTelefono.getText().isEmpty() || cbxGenero.getSelectedIndex() == 0 || 
            txtFechaNac.getDate() == null) {
            
            JOptionPane.showMessageDialog(null, "Por favor llene los campos obligatorios, incluyendo Fecha de Nacimiento y Género.");
            return;
        }

        LocalDate fechaNacimiento = txtFechaNac.getDate().toInstant()
