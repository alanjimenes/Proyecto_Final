...
public class GestionCitas extends JPanel {
    ...
    private void modificarCita() {
        ...
        citaSeleccionada.setFechaCita(nuevaFecha);
            ...
            if (citaSeleccionada != null) {
                ...
                if (citaSeleccionada.getFechaCita() != null) {
                    ...
                    if (cbxHora.getItemCount() > 0) {
                        int h = citaSeleccionada.getFechaCita().getHour();
                        int m = citaSeleccionada.getFechaCita().getMinute();
    ...
    private void cargarTablaCitas() {
        ...
        if (citas != null) {
            for (Cita c : citas) {
                ...
                String fecha = (c.getFechaCita() != null) ? c.getFechaCita().toString().replace("T", " ") : "N/A";

                model.addRow(new Object[]{c.getCodigoCita(), cliente, medico, fecha, c.getEstado()});
            }
        }
    }
