	...
	public static void main(String args[]) {
		...
		if (!usuariosCargados || !clinicaCargada) {
			...
			if (recuperarDesdeRespaldoTotal()) {
				...
				System.out.println("No se encontr� respaldo. Iniciando sistema limpio.");
		...
		try {
			...
			System.err.println("Error fatal al abrir el puerto 7000. �Ya est� corriendo el servidor?");
			System.exit(1);
		}
		...
		while (true) {
			try {
				...
				System.out.println("Error aceptando conexi�n: " + ioe);
			}
		}
	}
